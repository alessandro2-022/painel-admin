...
const Modal: React.FC<ModalProps> = ({ title, onClose, children }) => {
  return (
    ...
    >
      <div
        className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col animate-scale-up"
        onClick={e => e.stopPropagation()}
      >
        <header className="p-4 sm:p-6 flex justify-between items-center border-b border-slate-200 dark:border-slate-700">
